...
local Window = Rayfield:CreateWindow({
    Name = "JADENHUB",
    Title = "JADENHUB",
    LoadingTitle = "JADENHUB Loading...",
    LoadingSubtitle = "Brought to you by Jaden",
    sidebarLayout = true,
...
-- Home Tab (Socials placed at the top)
HomeTab:CreateSection({ Name = "📱 Socials" })
HomeTab:CreateButton({
    Name = "TikTok: lalamojaden2",
    Callback = function()
        if setclipboard then
            setclipboard("lalamojaden2")
            QuickToast("Copied", "TikTok username copied to clipboard")
        end
    end,
})
